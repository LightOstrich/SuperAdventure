...
namespace Engine.Models
{
    public class PlayerAttribute : INotifyPropertyChanged
    {
        ...
        public PlayerAttribute(string key, string displayName, string diceNotation) : this(key, displayName, diceNotation, DiceService.Instance.Roll(diceNotation).Value)
        {
        }
